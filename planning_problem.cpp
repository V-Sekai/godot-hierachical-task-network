...
PlanningProblem::std::vector<MethodWithParams> PlanningProblem::get_methods_for_task(const Task &p_task, const State &p_current_state) const {
...
PlanningProblem::std::vector<OperatorWithParams> PlanningProblem::get_operators_for_task(const Task &p_task, const State &p_current_state) const {
